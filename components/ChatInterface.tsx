...
//               <div className="rounded-2xl py-3 px-4 bg-white text-gray-900 rounded-bl-none shadow-sm ring-1 ring-inset ring-gray-200">
//                 <div className="flex items-center gap-1.5">
//                   {[0.3, 0.15, 0].map((delay, i) => (
//                     <div
//                       key={i}
//                       className="h-1.5 w-1.5 rounded-full bg-gray-400 animate animate-bounce"
